...
const NestedView = ({handleChangedEditSectionName}) => {
    ...
    const handleDeleteSubSection= async (subSectionId,sectionId) =>{
        const updatedSection = await deleteSubSection(
          ...
          if (updatedSection) {
            ...
            // ✅ Correctly update Redux with the full course + updated section
  ...
  return (
    <div >
        <div className=' rounded-lg mt-10 bg-richblack-700 p-10 px-8'>
            {course?.courseContent?.map((section)=>(
                <details key={section._id} open>

                <summary className='flex items-center justify-between gap-x-3 border-b-2 text-white'>
