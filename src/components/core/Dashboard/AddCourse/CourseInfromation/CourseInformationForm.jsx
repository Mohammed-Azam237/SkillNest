...
const CourseInformationForm = () => {
  ...
  console.log("Course object from Redux", course);
  ...
  return (
    ...
    <div className='flex flex-col space-y-2' >
      ...
      <input
        ...
        className='w-full min-h[130px] text-black form-style'
      />
      {
        errors.courseTitle && (
    ...
    <div className='flex flex-col space-y-2'>
      <label className='text-sm text-richblack-5'  htmlFor='courseShortDesc'>Course Short Desc<sup className='text-pink-200'>*</sup></label>
      <textarea
        id='courseShortDesc'
        placeholder='Enter Description'
        {...register("courseShortDesc",{required:true})}
        className=' w-full text-black form-style font-inter'
      />
      {
    ...
    <div className='relative flex flex-col space-y-2'>
      ...
      <input
        ...
        className='w-full text-black form-style !pl-6'
      />
      <HiOutlineCurrencyRupee className='absolute top-9 text-richblack-400'/>
      {
        errors.coursePrice &&(
    ...
    <div className='flex flex-col space-y-2'>
      ...
      <select
        ...
        className='text-black form-style w-full'
      >
     ...
     <ChipInput
        ...
        <div className='flex flex-col space-y-2'>
          ...
          <textarea
            ...
            className=' form-style min-h-[120px] w-full text-black'
          />
          {
