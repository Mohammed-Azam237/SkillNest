    ...
    <div className='text-white'>
        {
            loading ? (<div className="custom-loader"></div>):(
                <div className='max-w-[500px] p-4 lg:p-8 ml-[500px] mt-[130px] '>
                    <h1 className='text-[1.875rem] font-semibold leading-[2.375rem] text-richblack-5'>Choose New Password</h1>
                    <p className='my-4 text-[1.125rem] leading-[1.625rem] text-richblack-100' >Almost done.Enter your new password and your all set to go.</p>
                    <form onSubmit={handleOnSubmit}>
                    <div>
                        <div className='relative mt-4'>
                                <label className='w-full'>
                                        <p className='mb-1 text-[0.875rem] leading-[1.375rem] text-richblack-5'>New Password <sup class="text-pink-200">*</sup></p>
                                        <input
                                            required
                        ...
                        <div className='relative mt-4 '>
                            <label className='w-full'>
                                <p className='mb-1 text-[0.875rem] leading-[1.375rem] text-richblack-5'> Confirm New Password <sup class="text-pink-200">*</sup></p>
                                <input
                                    required
