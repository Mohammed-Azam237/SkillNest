...
const About = () => {
  return (
    <div className=' mx-auto mt-[50px] text-white w-full '>
        {/* section 1 */}
        <section className='bg-richblack-700 w-11/12 mx-auto'>
            <div className='relative mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-center text-white'>
                <header className='mx-auto py-20 text-4xl font-semibold lg:w-[70%]'>
                    Driving Innovation in Online Education for a 
                    <HighlightText text={"Brighter Future"}/>
                    <p className='mx-auto mt-3 text-center text-base font-medium text-richblack-300 lg:w-[95%]'>SkillNest is at the forefront of driving innovation in online education. We're 
                    passionate about creating a brighter future by offering cutting-edge courses,
                    leveraging emerging techonologies, and nurturing a vibrant leanring community.</p>
                </header>
        ...
        <section  className='border-b border-richblack-700 '>
            <div className='mx-auto flex w-full max-w-maxContent flex-col justify-between gap-10 text-richblack-500'>
        ...
        <section>
            ...
            {/* Founding story div */}
                ...
                <div className='flex flex-col items-center lg:gap-4 lg:flex-row justify-between'>
                    {/* left box */}
